...
public class eliminarProyecto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese el ID del Proyecto a eliminar");
        ...
        getContentPane().add(txtIdProyecto, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 230, 190, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eliminarProyecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
